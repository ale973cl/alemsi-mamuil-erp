        ...
        if recuperar:
            ...
            if not usuario_rec or "@" not in correo_rec:
                ...
                if not dfu.empty and int(dfu.iloc[0]["activo"]) == 1 and str(dfu.iloc[0].get("correo") or "").strip().lower() == correo_rec:
                    ...
                    if not ok:
                        st.error("No fue posible enviar el correo de recuperación. Contacta al Administrador Total.")
                        return
                ...
                st.success("Si los datos coinciden con una cuenta activa, recibirás un correo con instrucciones de recuperación.")
