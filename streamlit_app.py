        ...
        if not validar_rut_m11(rut_raw):
            ...
            if not df.empty:
                ...
                if st.button("Entrar a Comensal →", type="primary"):
                    ...
                    st.switch_page("pages/1_Comensal.py")
            else:
    ...
    with st.form("login"):
        ...
        if st.form_submit_button("Ingresar", type="primary"):
            ...
            if row:
                ...
                if row[1]=="Cocina": st.switch_page("pages/2_Cocina.py")
                elif row[1]=="Finanzas": st.switch_page("pages/4_Finanzas.py")
                elif row[1]=="Gerencia": st.switch_page("pages/5_Gerencia.py")
                else: st.switch_page("pages/1_Comensal.py")
