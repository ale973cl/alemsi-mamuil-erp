    ...
    try:
        with conn.session as s:
            ...
            for u,p,r,n in usuarios_default:
                execute_sql(s, "INSERT INTO usuarios (username,pwd,rol,nombre,activo,fecha_creacion) VALUES (%s,%s,%s,%s,1,%s) ON CONFLICT (username) DO NOTHING", (u, hash_pwd(p), r, n, datetime.now().isoformat()))
